...
import static org.mifos.workflow.infrastructure.support.cadence.core.CadenceFlowSupportConstants.CADENCE_WORKFLOW_SUPPORT_PROPERTIES_PREFIX;
...
@NoArgsConstructor
@AllArgsConstructor
@ConfigurationProperties(prefix = CADENCE_WORKFLOW_SUPPORT_PROPERTIES_PREFIX)
public class CadenceFlowSupportProperties {
    @Builder.Default
