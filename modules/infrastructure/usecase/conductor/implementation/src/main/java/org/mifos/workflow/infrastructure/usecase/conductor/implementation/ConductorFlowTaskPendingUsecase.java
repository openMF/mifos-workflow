 ...
 */
package org.mifos.workflow.infrastructure.usecase.conductor.implementation;

import static org.mifos.workflow.infrastructure.usecase.conductor.core.ConductorFlowUsecaseConstants.CONDUCTOR_WORKFLOW_PROPERTIES_ENABLED;
...
@Component
@ConditionalOnBooleanProperty(CONDUCTOR_WORKFLOW_PROPERTIES_ENABLED)
class ConductorFlowTaskPendingUsecase implements MifosFlowTaskPendingUsecase {
    @Override
